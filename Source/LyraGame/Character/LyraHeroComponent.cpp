		...
		if (const ULyraPawnData* PawnData = PawnExtComp->GetPawnData<ULyraPawnData>())
		{
			if (const ULyraInputConfig* InputConfig = PawnData->InputConfig)
			{
				...
				if (ensureMsgf(LyraIC, TEXT("Unexpected Input Component class! The Gameplay Abilities will not be bound to their inputs. Change the input component to ULyraInputComponent or a subclass of it.")))
				{
					...
					{
						UE_LOG(LogTemp, Warning, TEXT("AbilitySystem component triggered"));
						LyraIC->BindNativeAction(InputConfig, LyraGameplayTags::InputTag_ConfirmAbility, ETriggerEvent::Triggered, LyraASC, &UAbilitySystemComponent::LocalInputConfirm, /*bLogIfNotFound=*/ false);
						LyraIC->BindNativeAction(InputConfig, LyraGameplayTags::InputTag_CancelAbility, ETriggerEvent::Triggered, LyraASC, &UAbilitySystemComponent::LocalInputCancel, /*bLogIfNotFound=*/ false);
