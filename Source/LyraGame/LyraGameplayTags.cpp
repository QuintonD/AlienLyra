...
namespace LyraGameplayTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(InputTag_ConfirmAbility, "InputTag.ConfirmAbility", "Confirm ability at target location.");
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(InputTag_CancelAbility, "InputTag.CancelAbility", "Cancel ability targeting.");
