...
#include UE_INLINE_GENERATED_CPP_BY_NAME(DungeonTestClass)
...
UE_DEFINE_GAMEPLAY_TAG(TAG_DungeonTestClass_Energy, "AttributeSets.DungeonTestClass.Energy");
FGameplayTag UDungeonTestClass::GetGameplayTag_Energy() const
{
	return FGameplayTag::RequestGameplayTag(FName("AttributeSets.DungeonTestClass.Energy"));
}
UE_DEFINE_GAMEPLAY_TAG(TAG_DungeonTestClass_Agility, "AttributeSets.DungeonTestClass.Agility");
FGameplayTag UDungeonTestClass::GetGameplayTag_Agility() const
{
	return FGameplayTag::RequestGameplayTag(FName("AttributeSets.DungeonTestClass.Agility"));
}
UE_DEFINE_GAMEPLAY_TAG(TAG_DungeonTestClass_Strength, "AttributeSets.DungeonTestClass.Strength");
FGameplayTag UDungeonTestClass::GetGameplayTag_Strength() const
{
	return FGameplayTag::RequestGameplayTag(FName("AttributeSets.DungeonTestClass.Strength"));
}
UE_DEFINE_GAMEPLAY_TAG(TAG_DungeonTestClass_Shield, "AttributeSets.DungeonTestClass.Shield");
FGameplayTag UDungeonTestClass::GetGameplayTag_Shield() const
{
	return FGameplayTag::RequestGameplayTag(FName("AttributeSets.DungeonTestClass.Shield"));
}
...
UDungeonTestClass::UDungeonTestClass()
	: Energy(0.0f), Agility(0.0f), Strength(0.0f), Shield(0.0f)
{
}

#pragma region Replication
void UDungeonTestClass::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
	Super::GetLifetimeReplicatedProps(OutLifetimeProps);
	DOREPLIFETIME_CONDITION_NOTIFY(UDungeonTestClass, Energy, COND_OwnerOnly, REPNOTIFY_Always);
	DOREPLIFETIME_CONDITION_NOTIFY(UDungeonTestClass, Agility, COND_OwnerOnly, REPNOTIFY_Always);
	DOREPLIFETIME_CONDITION_NOTIFY(UDungeonTestClass, Strength, COND_OwnerOnly, REPNOTIFY_Always);
	DOREPLIFETIME_CONDITION_NOTIFY(UDungeonTestClass, Shield, COND_OwnerOnly, REPNOTIFY_Always);

}

void UDungeonTestClass::OnRep_Energy(const FGameplayAttributeData& OldValue)
{
	...
	if (IsValid(ASC))
	{
		ASC->SetBaseAttributeValueFromReplication(FGameplayAttribute(Prop), Energy, OldValue);
	}
	else
	{
		UE_LOG(GameAttributeSet, Error, TEXT("UDungeonTestClasss::OnRep_Energy: No valid ASC found"));
	}
}

void UDungeonTestClass::OnRep_Agility(const FGameplayAttributeData& OldValue)
{
	...
	if (IsValid(ASC))
	{
		ASC->SetBaseAttributeValueFromReplication(FGameplayAttribute(Prop), Agility, OldValue);
	}
	else
	{
		UE_LOG(GameAttributeSet, Error, TEXT("UDungeonTestClasss::OnRep_Agility: No valid ASC found"));
	}
}

void UDungeonTestClass::OnRep_Strength(const FGameplayAttributeData& OldValue)
{
	...
	{
		UE_LOG(GameAttributeSet, Error, TEXT("UDungeonTestClasss::OnRep_Strength: No valid ASC found"));
	}
}

void UDungeonTestClass::OnRep_Shield(const FGameplayAttributeData& OldValue)
{
	...
	if (IsValid(ASC))
	{
		ASC->SetBaseAttributeValueFromReplication(FGameplayAttribute(Prop), Shield, OldValue);
	}
	else
	{
		UE_LOG(GameAttributeSet, Error, TEXT("UDungeonTestClasss::OnRep_Shield: No valid ASC found"));
	}
}
...
void UDungeonTestClass::PostGameplayEffectExecute(const FGameplayEffectModCallbackData& Data)
{
	Super::PostGameplayEffectExecute(Data);
	if (Data.EvaluatedData.Magnitude != 0.0f)
	{
		FGameplayTag Tag = FGameplayTag::RequestGameplayTag(FName("AttributeSets.DungeonTestClass." + Data.EvaluatedData.Attribute.AttributeName));
		if (Tag.IsValid())
		{
...
void UDungeonTestClass::PreAttributeBaseChange(const FGameplayAttribute& Attribute, float& NewValue) const
{
	Super::PreAttributeBaseChange(Attribute, NewValue);
	ClampAttribute(Attribute, NewValue);
}

void UDungeonTestClass::PreAttributeChange(const FGameplayAttribute& Attribute, float& NewValue)
{
	Super::PreAttributeChange(Attribute, NewValue);
	ClampAttribute(Attribute, NewValue);
}

void UDungeonTestClass::PostAttributeChange(const FGameplayAttribute& Attribute, float OldValue, float NewValue)
{
	...
	if (IsValid(ASC))
	{
		...
		{
			FGameplayTag Tag = FGameplayTag::RequestGameplayTag(FName("AttributeSets.DungeonTestClass." + Attribute.AttributeName));
			if (Tag.IsValid())
			{
...
void UDungeonTestClass::OnAttributeAggregatorCreated(const FGameplayAttribute& Attribute, FAggregator* NewAggregator) const
{
...
void UDungeonTestClass::ClampAttribute(const FGameplayAttribute& Attribute, float& NewValue) const
{
